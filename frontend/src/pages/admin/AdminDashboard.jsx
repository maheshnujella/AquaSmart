...
import { Package, Users, ShoppingBag, Calendar, Stethoscope, Loader2, TrendingUp, Fuel, IndianRupee, RefreshCw } from 'lucide-react';
...
const AdminDashboard = () => {
  ...
  const fetchStats = async () => {
    ...
    try {
      ...
      // silently fail — StatCards show — for errored stats
    } finally {
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6">
              <StatCard
                label="Total Users"
                value={stats.users}
                sub="Farmers, Shopkeepers & Doctors"
                color="bg-blue-50 border-blue-100 text-blue-900"
              />
              <StatCard
                label="Total Orders"
                value={stats.orders}
                sub="All product & service orders"
              ...
              <StatCard
                ...
                sub="Marketplace buy/sell posts"
