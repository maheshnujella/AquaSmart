        ...
        {step === 2 && (
          <div className="space-y-8 animate-fade-in flex-1">
            ...
            <div className="space-y-4">
              ...
              ></textarea>
              <div 
                className={`relative flex flex-col items-center justify-center border-2 border-dashed rounded-3xl p-10 transition-colors cursor-pointer group ${isDragging ? 'border-orange-500 bg-orange-50' : 'border-slate-300 bg-slate-50 hover:bg-slate-100'}`}
              ...
              >
                 ...
                 <div className="text-center space-y-2 pointer-events-none">
                   <Camera className={`w-10 h-10 mx-auto transition-all ${isDragging ? 'text-orange-500 scale-110' : 'text-slate-400 group-hover:text-orange-500 group-hover:scale-110'}`} />
                   <p className="text-sm font-semibold text-slate-600">Drag & Drop or <span className="text-orange-600">Browse Photos</span></p>
